...
const char* posToConstChar(uint8_t pos, uint8_t shift); // returns button name from position
const char* shiftFun(uint8_t number, uint8_t shift); // to handle shift inputs
